  ...
  if (this.annotationActive) {
     ...
     */
     this.compositebutton = jQuery('<img>', {
      title: 'Create Composite Dataset',
    ...
    */
     ...
     */
     this.compositebutton.on('click', function () {
      ...
      location.href = "/camicroscope_bwang/osdCamicroscope.php?tissueId="+tissueId+"&cancerType="+cancerType;
    }.bind(this))
    ...
    this.dotToolButton.on('click', function () {
        ...
        var tissueId = annotool.iid;
	    var cancerType = annotool.cancerType;		  
        location.href = "/camicroscope_dots/osdCamicroscope.php?tissueId="+tissueId+"&cancerType="+cancerType;
    }.bind(this))
