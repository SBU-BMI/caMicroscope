...
annotools.prototype.drawDots = function() {
    ...
    */
    ...
    svgHtmlDot.on('click', function() {
		...
		// aj start
		/*
		var tmpCircle = d3.selectAll("circle");
		console.log("tmpCircle: " + tmpCircle);
		console.log("tmpCircle length: " + tmpCircle[]);
		*/
		//circle.exit().remove();
		//aj new start
		...
		//console.log('circleNodes length: ' + circleNodes.length);
		...
		//d3.selectAll("#groupOfCircles").exit().remove();
