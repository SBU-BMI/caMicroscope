...
<div class="container">
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Dot Spatial Annotation Tool</h3>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>The alpha version of the Dot Spatial Annotation Application.<br>
                       For questions, please contact Alina Jasniewski (alina.jasniewski@stonybrook.edu)</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4" title='caMicroscope - SBU Main Branch'><a class="btn btn-success btn-block" href="sbu_flex/">caMicroscope / Dot Tool</a></div>
                <div class="col-md-8">The second button on the caMicroscope toolbar allows quick access to the 'Dot Spatial Annotation Tool'.
                </div>
            </div>
            <div class="row"><br></div>
            <div class="row">
                <div class="col-md-4" title='Access a Training Image'><a class="btn btn-success btn-block"
                                         href="/camicroscope_dots/osdCamicroscope.php?tissueId=TCGA-55-8089-01Z-00-DX1&cancerType=luad">Training</a>
                </div>
                <div class="col-md-8">Open a training image.
                </div>
            </div>
            <div class="row"><br></div>
            <div class="row">
                <div class="col-md-4"><a class="btn btn-success btn-block"
                                         href="/camicroscope_alina/tmpDotTool/camicDotToolWsiList.php?type=luad&page=1">Students</a>
                </div>
                <div class="col-md-8">Cancer type - LUAD.  Select image by case id.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title">Lymphocyte and Plasma Cell Annotation</h3>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>Semi-automatic Lymphocyte + Plasma Cell Annotation.<br>
                       For questions, please contact Le Hou (le.hou@stonybrook.edu)</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4"><a class="btn btn-info btn-block"
                                         href="/camicroscope_levu/php/lym_proj_wsi_list.php?type=luad&page=1">Lung Adeno (LUAD)</a>
                </div>
                <div class="col-md-8">Annotate Lymphocyte + Plasma Cell in whole slide images of LUAD.
                </div>
            </div>
            <div class="row"><br></div>
            <div class="row">
                <div class="col-md-4"><a class="btn btn-info btn-block"
                                         href="/camicroscope_levu/php/lym_proj_wsi_list.php?type=luad&page=1">Other Cancers</a>
                </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4"><a class="btn btn-info btn-block"
                                         href="http://sbu-bmi.github.io/FeatureScapeApps/featurescape/fig4.html">FeatureExplorer</a>
                </div>
                <div class="col-md-8">An interactive tool to allow patient-level feature exploration across multiple
                    dimensions.
                </div>
            </div>
            <div class="row"><br></div>
            <div class="row">
                <div class="col-md-4"><a class="btn btn-info btn-block"
                                         href="http://sbu-bmi.github.io/FeatureScapeApps/featurescape/">FeatureScape</a>
                </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-4"><a class="btn btn-warning btn-block"
                                         href="http://sbu-bmi.github.io/FeatureScapeApps/openHealth/?http://sbu-bmi.github.io/FeatureScapeApps/openHealth/tcgascope.js">TCGAScope</a>
                </div>
                <div class="col-md-8">An interactive dashboard to explore interrelations between patient
                    demographics,
